...
// in simulator we redefine to format for AVF1507Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.avf1507project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avf1507project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVF1507Project3NativeItemNone = -1, 
	UIAVF1507Project3NativeItemSpinner = -2,
	UIAVF1507Project3NativeItemProgressBar = -3,
	
	UIAVF1507Project3NativeItemSlider = -4,
	UIAVF1507Project3NativeItemSwitch = -5,
	UIAVF1507Project3NativeItemMultiButton = -6,
	UIAVF1507Project3NativeItemSegmented = -7,
	
	UIAVF1507Project3NativeItemTextView = -8,
	UIAVF1507Project3NativeItemTextField = -9,
	UIAVF1507Project3NativeItemSearchBar = -10,
	
	UIAVF1507Project3NativeItemPicker = -11,
	UIAVF1507Project3NativeItemDatePicker = -12,
	
	UIAVF1507Project3NativeItemInfoLight = -13,
	UIAVF1507Project3NativeItemInfoDark = -14,
	
	UIAVF1507Project3NativeItemDisclosure = -15,
	
	UIAVF1507Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AVF1507Project3 instances of
