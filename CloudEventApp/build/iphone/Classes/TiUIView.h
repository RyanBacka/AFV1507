...
/**
 Base class for all CloudEventApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the CloudEventApp view hierarchy (such as wrapped iOS UIViews) was touched.
