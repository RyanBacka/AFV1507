...
// in simulator we redefine to format for CloudEventApp Developer console
...
{\
	NSString * exceptionName = [@"org.cloudeventapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.cloudeventapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UICloudEventAppNativeItemNone = -1, 
	UICloudEventAppNativeItemSpinner = -2,
	UICloudEventAppNativeItemProgressBar = -3,
	
	UICloudEventAppNativeItemSlider = -4,
	UICloudEventAppNativeItemSwitch = -5,
	UICloudEventAppNativeItemMultiButton = -6,
	UICloudEventAppNativeItemSegmented = -7,
	
	UICloudEventAppNativeItemTextView = -8,
	UICloudEventAppNativeItemTextField = -9,
	UICloudEventAppNativeItemSearchBar = -10,
	
	UICloudEventAppNativeItemPicker = -11,
	UICloudEventAppNativeItemDatePicker = -12,
	
	UICloudEventAppNativeItemInfoLight = -13,
	UICloudEventAppNativeItemInfoDark = -14,
	
	UICloudEventAppNativeItemDisclosure = -15,
	
	UICloudEventAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CloudEventApp instances of
