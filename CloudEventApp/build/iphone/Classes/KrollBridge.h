...
@interface CloudEventAppObject : KrollCoverageObject {
#else
@interface CloudEventAppObject : KrollObject {
#endif
@private
...
extern NSString * CloudEventApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	CloudEventAppObject *_cloudeventapp;
    KrollObject* console;
	BOOL shutdown;
