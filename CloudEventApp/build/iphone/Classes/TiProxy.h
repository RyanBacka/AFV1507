...
//Rare exceptions to indicate a bug in the _cloudeventapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for CloudEventApp proxies.
 */
