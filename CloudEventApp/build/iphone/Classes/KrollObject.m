...
//@interface CloudEventAppObject : NSObject
//@end

@interface CloudEventAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CloudEventAppObject class]])
		{
			for (NSString *key in [[(CloudEventAppObject*)o modules] allKeys])
			{
