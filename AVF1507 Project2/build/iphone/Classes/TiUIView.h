...
/**
 Base class for all AVF1507Project2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AVF1507Project2 view hierarchy (such as wrapped iOS UIViews) was touched.
