...
/**
 The base class for all AVF1507Project2 modules
 */
...
/**
 AVF1507Project2 Platform calls this method on startup.
 */
-(void)startup;

/**
 AVF1507Project2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AVF1507Project2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 AVF1507Project2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 AVF1507Project2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
