...
@interface AVF1507Project2Object : KrollCoverageObject {
#else
@interface AVF1507Project2Object : KrollObject {
#endif
@private
...
extern NSString * AVF1507Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AVF1507Project2Object *_avf1507project2;
    KrollObject* console;
	BOOL shutdown;
