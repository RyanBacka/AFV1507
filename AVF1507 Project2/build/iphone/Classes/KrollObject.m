...
//@interface AVF1507Project2Object : NSObject
//@end

@interface AVF1507Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AVF1507Project2Object class]])
		{
			for (NSString *key in [[(AVF1507Project2Object*)o modules] allKeys])
			{
