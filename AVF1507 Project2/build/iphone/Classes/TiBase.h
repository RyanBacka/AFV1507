...
// in simulator we redefine to format for AVF1507Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.avf1507project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avf1507project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVF1507Project2NativeItemNone = -1, 
	UIAVF1507Project2NativeItemSpinner = -2,
	UIAVF1507Project2NativeItemProgressBar = -3,
	
	UIAVF1507Project2NativeItemSlider = -4,
	UIAVF1507Project2NativeItemSwitch = -5,
	UIAVF1507Project2NativeItemMultiButton = -6,
	UIAVF1507Project2NativeItemSegmented = -7,
	
	UIAVF1507Project2NativeItemTextView = -8,
	UIAVF1507Project2NativeItemTextField = -9,
	UIAVF1507Project2NativeItemSearchBar = -10,
	
	UIAVF1507Project2NativeItemPicker = -11,
	UIAVF1507Project2NativeItemDatePicker = -12,
	
	UIAVF1507Project2NativeItemInfoLight = -13,
	UIAVF1507Project2NativeItemInfoDark = -14,
	
	UIAVF1507Project2NativeItemDisclosure = -15,
	
	UIAVF1507Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AVF1507Project2 instances of
