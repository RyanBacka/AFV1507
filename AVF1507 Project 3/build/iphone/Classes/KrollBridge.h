...
@interface AVF1507Project3Object : KrollCoverageObject {
#else
@interface AVF1507Project3Object : KrollObject {
#endif
@private
...
extern NSString * AVF1507Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AVF1507Project3Object *_avf1507project3;
    KrollObject* console;
	BOOL shutdown;
