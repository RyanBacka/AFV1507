...
// in simulator we redefine to format for AVF1507Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.avf1507project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.avf1507project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAVF1507Project1NativeItemNone = -1, 
	UIAVF1507Project1NativeItemSpinner = -2,
	UIAVF1507Project1NativeItemProgressBar = -3,
	
	UIAVF1507Project1NativeItemSlider = -4,
	UIAVF1507Project1NativeItemSwitch = -5,
	UIAVF1507Project1NativeItemMultiButton = -6,
	UIAVF1507Project1NativeItemSegmented = -7,
	
	UIAVF1507Project1NativeItemTextView = -8,
	UIAVF1507Project1NativeItemTextField = -9,
	UIAVF1507Project1NativeItemSearchBar = -10,
	
	UIAVF1507Project1NativeItemPicker = -11,
	UIAVF1507Project1NativeItemDatePicker = -12,
	
	UIAVF1507Project1NativeItemInfoLight = -13,
	UIAVF1507Project1NativeItemInfoDark = -14,
	
	UIAVF1507Project1NativeItemDisclosure = -15,
	
	UIAVF1507Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AVF1507Project1 instances of
