...
//@interface AVF1507Project1Object : NSObject
//@end

@interface AVF1507Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AVF1507Project1Object class]])
		{
			for (NSString *key in [[(AVF1507Project1Object*)o modules] allKeys])
			{
