...
@interface AVF1507Project1Object : KrollCoverageObject {
#else
@interface AVF1507Project1Object : KrollObject {
#endif
@private
...
extern NSString * AVF1507Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	AVF1507Project1Object *_avf1507project1;
    KrollObject* console;
	BOOL shutdown;
